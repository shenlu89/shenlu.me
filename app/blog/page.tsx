    ...
    <>
      <div className="flex flex-col relative w-full">
        ...
        <div className="relative w-full mb-4">
          <MagnifyingGlassIcon className="flex left-3 top-1/2 translate-y-[-50%] absolute w-5 h-5 text-gray-600" />
          <XCircleIcon
            onClick={() => {
          ...
          <input
            ...
            value={serachPosts}
            className="w-full px-10 py-2 text-black bg-white dark:border-black dark:focus:border-black border focus:border-gray-400 rounded-sm focus:outline-0"
          />
        </div>
      </div>
