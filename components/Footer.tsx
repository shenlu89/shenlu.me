...
const Footer: NextPage = () => {
    return (
        <footer className='flex justify-between max-w-3xl container mx-auto py-2'>
            <p className='py-2 m-2 text-gray-400 underline-offset-3'>© 2022 <a className='hover:underline hover:text-black dark:hover:text-white' href={'https://github.com/shenlu89'} target={'_blank'}>Shen Lu</a>. All rights reserved.</p>
            <ul className='flex items-center py-2 m-2'>
                ...
                <Link className='flex' href="https://github.com/shenlu89/shenlu89.github.io" target={'_blank'}>
                    <svg className="text-gray-400 hover:text-black dark:hover:text-white" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
