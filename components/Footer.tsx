...
const Footer: NextPage = () => {
  return (
    <footer className="flex justify-between max-w-3xl container mx-auto py-2 tracking-tight">
      <p className="py-2 m-2 text-gray-400 underline-offset-3">
      ...
      <ul className="flex items-center py-2 m-2">
        ...
        >
          <svg
            className="text-gray-400 hover:text-twitter"
