...
After recieving my new Macbook, I started setting up development environment on **MacOS**.
To set up **Git** on **MacOS**, I generated a new **SSH** key on my Mackbook and
add it to my **GitHub** account to enable authentication for **Git** operations over **SSH**.
...
## 2. Adding a new SSH key to GitHub account
