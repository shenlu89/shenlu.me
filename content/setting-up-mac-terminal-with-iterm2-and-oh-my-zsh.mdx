...
When I used the terminal on **Ubuntu**, there is a keyboard shortcut, `Ctrl` + `Alt` + `T`, which helped me quickly open a terminal. 
...
Then I configure the shortcut as follows:
