...
In 2021, I came across a video on Youtube by "妈咪说MommyTalk" titled "[如何优雅的编辑数学公式？LaTeX公式入门](https://www.youtube.com/watch?v=4MkdR6qChSY)" In the video, the creator had built their own formula editor, complete with an OCR image recognition feature. At the time, I felt the tool was quite feature-complete, but the user interface didn't quite match my aesthetic, and it seemed the tech stack could be optimized.
